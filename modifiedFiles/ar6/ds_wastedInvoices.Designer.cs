...
namespace Novin {
    ...
    public partial class ds_wastedInvoices : global::System.Data.DataSet {
        ...
        public partial class tbl_invoicesWastedDataTable : global::System.Data.TypedTableBase<tbl_invoicesWastedRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            public tbl_invoicesWastedRow Addtbl_invoicesWastedRow(int invoiceWasted_id, tbl_accDocsRow parenttbl_accDocsRowByFK_tbl_invoicesWasted_tbl_accDocs1, string invoiceWasted_date, long invoiceWasted_totalPrice, string invoiceWasted_comment) {
        ...
        public partial class tbl_itemsWastedDataTable : global::System.Data.TypedTableBase<tbl_itemsWastedRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            public tbl_itemsWastedRow Addtbl_itemsWastedRow(tbl_invoicesWastedRow parenttbl_invoicesWastedRowByFK_tbl_itemsWasted_tbl_invoicesWasted, int object_id, int itemWasted_unitCount, int itemWasted_retailCount, long itemWasted_retailPrice, string itemWasted_comment) {
...
SELECT accDoc_id, accDoc_price, accDoc_date, accDoc_comment, accDoc_isItPerm FROM tbl_accDocs WHERE (accDoc_id = @accDoc_id)";
    ...
    public partial class viw_itemsWastedTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT invoiceWasted_id, objectTitle, objectUnit_title, itemWasted_unitCount, ite" +
                "mWasted_retailCount, objectTotalCount, object_retailInUnit, itemWasted_retailPri" +
                "ce, objectTotalPrice, itemWasted_comment FROM dbo.viw_itemsWasted";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(ds_wastedInvoices.viw_itemsWastedDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual ds_wastedInvoices.viw_itemsWastedDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
    ...
    public partial class tbl_invoicesWastedTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[tbl_invoicesWasted] WHERE (([invoiceWasted_id] = @Original_invoiceWasted_id) AND ([accDoc_id] = @Original_accDoc_id) AND ([invoiceWasted_date] = @Original_invoiceWasted_date) AND ([invoiceWasted_totalPrice] = @Original_invoiceWasted_totalPrice) AND ((@IsNull_invoiceWasted_comment = 1 AND [invoiceWasted_comment] IS NULL) OR ([invoiceWasted_comment] = @Original_invoiceWasted_comment)))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[tbl_invoicesWasted] ([invoiceWasted_id], [accDoc_id], [invoiceWasted_date], [invoiceWasted_totalPrice], [invoiceWasted_comment]) VALUES (@invoiceWasted_id, @accDoc_id, @invoiceWasted_date, @invoiceWasted_totalPrice, @invoiceWasted_comment);
SELECT invoiceWasted_id, accDoc_id, invoiceWasted_date, invoiceWasted_totalPrice, invoiceWasted_comment FROM tbl_invoicesWasted WHERE (invoiceWasted_id = @invoiceWasted_id)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[tbl_invoicesWasted] SET [invoiceWasted_id] = @invoiceWasted_id, [accDoc_id] = @accDoc_id, [invoiceWasted_date] = @invoiceWasted_date, [invoiceWasted_totalPrice] = @invoiceWasted_totalPrice, [invoiceWasted_comment] = @invoiceWasted_comment WHERE (([invoiceWasted_id] = @Original_invoiceWasted_id) AND ([accDoc_id] = @Original_accDoc_id) AND ([invoiceWasted_date] = @Original_invoiceWasted_date) AND ([invoiceWasted_totalPrice] = @Original_invoiceWasted_totalPrice) AND ((@IsNull_invoiceWasted_comment = 1 AND [invoiceWasted_comment] IS NULL) OR ([invoiceWasted_comment] = @Original_invoiceWasted_comment)));
SELECT invoiceWasted_id, accDoc_id, invoiceWasted_date, invoiceWasted_totalPrice, invoiceWasted_comment FROM tbl_invoicesWasted WHERE (invoiceWasted_id = @invoiceWasted_id)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT invoiceWasted_id, accDoc_id, invoiceWasted_date, invoiceWasted_totalPrice," +
                " invoiceWasted_comment FROM dbo.tbl_invoicesWasted";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(ds_wastedInvoices.tbl_invoicesWastedDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual ds_wastedInvoices.tbl_invoicesWastedDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(int Original_invoiceWasted_id, int Original_accDoc_id, string Original_invoiceWasted_date, long Original_invoiceWasted_totalPrice, string Original_invoiceWasted_comment) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(int invoiceWasted_id, int accDoc_id, string invoiceWasted_date, long invoiceWasted_totalPrice, string invoiceWasted_comment) {
        ...
        public virtual int Update(int invoiceWasted_id, int accDoc_id, string invoiceWasted_date, long invoiceWasted_totalPrice, string invoiceWasted_comment, int Original_invoiceWasted_id, int Original_accDoc_id, string Original_invoiceWasted_date, long Original_invoiceWasted_totalPrice, string Original_invoiceWasted_comment) {
            ...
            this.Adapter.UpdateCommand.Parameters[5].Value = ((int)(Original_invoiceWasted_id));
            this.Adapter.UpdateCommand.Parameters[6].Value = ((int)(Original_accDoc_id));
            if ((Original_invoiceWasted_date == null)) {
                throw new global::System.ArgumentNullException("Original_invoiceWasted_date");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[7].Value = ((string)(Original_invoiceWasted_date));
            }
            this.Adapter.UpdateCommand.Parameters[8].Value = ((long)(Original_invoiceWasted_totalPrice));
            if ((Original_invoiceWasted_comment == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[10].Value = ((string)(Original_invoiceWasted_comment));
            }
            global::System.Data.ConnectionState previousConnectionState = this.Adapter.UpdateCommand.Connection.State;
            if (((this.Adapter.UpdateCommand.Connection.State & global::System.Data.ConnectionState.Open) 
                        != global::System.Data.ConnectionState.Open)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int accDoc_id, string invoiceWasted_date, long invoiceWasted_totalPrice, string invoiceWasted_comment, int Original_invoiceWasted_id, int Original_accDoc_id, string Original_invoiceWasted_date, long Original_invoiceWasted_totalPrice, string Original_invoiceWasted_comment) {
            return this.Update(Original_invoiceWasted_id, accDoc_id, invoiceWasted_date, invoiceWasted_totalPrice, invoiceWasted_comment, Original_invoiceWasted_id, Original_accDoc_id, Original_invoiceWasted_date, Original_invoiceWasted_totalPrice, Original_invoiceWasted_comment);
        }
    }
    ...
    public partial class tbl_itemsWastedTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[tbl_itemsWasted] WHERE (([itemWasted_id] = @Original_itemWasted_id) AND ([invoiceWasted_id] = @Original_invoiceWasted_id) AND ([object_id] = @Original_object_id) AND ([itemWasted_unitCount] = @Original_itemWasted_unitCount) AND ([itemWasted_retailCount] = @Original_itemWasted_retailCount) AND ([itemWasted_retailPrice] = @Original_itemWasted_retailPrice) AND ((@IsNull_itemWasted_comment = 1 AND [itemWasted_comment] IS NULL) OR ([itemWasted_comment] = @Original_itemWasted_comment)))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[tbl_itemsWasted] ([invoiceWasted_id], [object_id], [itemWasted_unitCount], [itemWasted_retailCount], [itemWasted_retailPrice], [itemWasted_comment]) VALUES (@invoiceWasted_id, @object_id, @itemWasted_unitCount, @itemWasted_retailCount, @itemWasted_retailPrice, @itemWasted_comment);
SELECT itemWasted_id, invoiceWasted_id, object_id, itemWasted_unitCount, itemWasted_retailCount, itemWasted_retailPrice, itemWasted_comment FROM tbl_itemsWasted WHERE (itemWasted_id = SCOPE_IDENTITY())";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@invoiceWasted_id", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "invoiceWasted_id", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[tbl_itemsWasted] SET [invoiceWasted_id] = @invoiceWasted_id, [object_id] = @object_id, [itemWasted_unitCount] = @itemWasted_unitCount, [itemWasted_retailCount] = @itemWasted_retailCount, [itemWasted_retailPrice] = @itemWasted_retailPrice, [itemWasted_comment] = @itemWasted_comment WHERE (([itemWasted_id] = @Original_itemWasted_id) AND ([invoiceWasted_id] = @Original_invoiceWasted_id) AND ([object_id] = @Original_object_id) AND ([itemWasted_unitCount] = @Original_itemWasted_unitCount) AND ([itemWasted_retailCount] = @Original_itemWasted_retailCount) AND ([itemWasted_retailPrice] = @Original_itemWasted_retailPrice) AND ((@IsNull_itemWasted_comment = 1 AND [itemWasted_comment] IS NULL) OR ([itemWasted_comment] = @Original_itemWasted_comment)));
SELECT itemWasted_id, invoiceWasted_id, object_id, itemWasted_unitCount, itemWasted_retailCount, itemWasted_retailPrice, itemWasted_comment FROM tbl_itemsWasted WHERE (itemWasted_id = @itemWasted_id)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@invoiceWasted_id", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "invoiceWasted_id", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT itemWasted_id, invoiceWasted_id, object_id, itemWasted_unitCount, itemWast" +
                "ed_retailCount, itemWasted_retailPrice, itemWasted_comment FROM dbo.tbl_itemsWas" +
                "ted";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(ds_wastedInvoices.tbl_itemsWastedDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual ds_wastedInvoices.tbl_itemsWastedDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(int Original_itemWasted_id, int Original_invoiceWasted_id, int Original_object_id, int Original_itemWasted_unitCount, int Original_itemWasted_retailCount, long Original_itemWasted_retailPrice, string Original_itemWasted_comment) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(int invoiceWasted_id, int object_id, int itemWasted_unitCount, int itemWasted_retailCount, long itemWasted_retailPrice, string itemWasted_comment) {
            this.Adapter.InsertCommand.Parameters[0].Value = ((int)(invoiceWasted_id));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int invoiceWasted_id, int object_id, int itemWasted_unitCount, int itemWasted_retailCount, long itemWasted_retailPrice, string itemWasted_comment, int Original_itemWasted_id, int Original_invoiceWasted_id, int Original_object_id, int Original_itemWasted_unitCount, int Original_itemWasted_retailCount, long Original_itemWasted_retailPrice, string Original_itemWasted_comment, int itemWasted_id) {
            this.Adapter.UpdateCommand.Parameters[0].Value = ((int)(invoiceWasted_id));
            ...
            this.Adapter.UpdateCommand.Parameters[6].Value = ((int)(Original_itemWasted_id));
            this.Adapter.UpdateCommand.Parameters[7].Value = ((int)(Original_invoiceWasted_id));
            this.Adapter.UpdateCommand.Parameters[8].Value = ((int)(Original_object_id));
            this.Adapter.UpdateCommand.Parameters[9].Value = ((int)(Original_itemWasted_unitCount));
            this.Adapter.UpdateCommand.Parameters[10].Value = ((int)(Original_itemWasted_retailCount));
            this.Adapter.UpdateCommand.Parameters[11].Value = ((long)(Original_itemWasted_retailPrice));
            if ((Original_itemWasted_comment == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[13].Value = ((string)(Original_itemWasted_comment));
            }
            this.Adapter.UpdateCommand.Parameters[14].Value = ((int)(itemWasted_id));
            global::System.Data.ConnectionState previousConnectionState = this.Adapter.UpdateCommand.Connection.State;
            if (((this.Adapter.UpdateCommand.Connection.State & global::System.Data.ConnectionState.Open) 
                        != global::System.Data.ConnectionState.Open)) {
                this.Adapter.UpdateCommand.Connection.Open();
        ...
        public virtual int Update(int invoiceWasted_id, int object_id, int itemWasted_unitCount, int itemWasted_retailCount, long itemWasted_retailPrice, string itemWasted_comment, int Original_itemWasted_id, int Original_invoiceWasted_id, int Original_object_id, int Original_itemWasted_unitCount, int Original_itemWasted_retailCount, long Original_itemWasted_retailPrice, string Original_itemWasted_comment) {
            return this.Update(invoiceWasted_id, object_id, itemWasted_unitCount, itemWasted_retailCount, itemWasted_retailPrice, itemWasted_comment, Original_itemWasted_id, Original_invoiceWasted_id, Original_object_id, Original_itemWasted_unitCount, Original_itemWasted_retailCount, Original_itemWasted_retailPrice, Original_itemWasted_comment, Original_itemWasted_id);
        }
    }
