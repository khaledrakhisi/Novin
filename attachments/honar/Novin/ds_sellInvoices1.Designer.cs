...
SELECT itemSell_id, invoiceSell_id, invoiceSell_kind, object_id, itemSell_unitCount, itemSell_retailCount, itemSell_retailPrice, itemSell_totalPrice, itemSell_discountPercent, itemSell_visitorPercent, itemSell_transportPrice, itemSell_taxPercent, itemSell_comment FROM tbl_itemsSell WHERE (itemSell_id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [tbl_itemsSell] SET [invoiceSell_id] = @invoiceSell_id, [invoiceSell_kind]" +
                ...
                "nt WHERE (([itemSell_id] = @Original_itemSell_id) AND ([invoiceSell_id] = @Origi" +
                "nal_invoiceSell_id) AND ([invoiceSell_kind] = @Original_invoiceSell_kind) AND ([" +
                "object_id] = @Original_object_id) AND ([itemSell_unitCount] = @Original_itemSell" +
                "_unitCount) AND ([itemSell_retailCount] = @Original_itemSell_retailCount) AND ([" +
                "itemSell_retailPrice] = @Original_itemSell_retailPrice) AND ([itemSell_totalPric" +
                "e] = @Original_itemSell_totalPrice) AND ([itemSell_discountPercent] = @Original_" +
                "itemSell_discountPercent) AND ([itemSell_visitorPercent] = @Original_itemSell_vi" +
                "sitorPercent) AND ([itemSell_transportPrice] = @Original_itemSell_transportPrice" +
                ") AND ((@IsNull_itemSell_taxPercent = 1 AND [itemSell_taxPercent] IS NULL) OR ([" +
                "itemSell_taxPercent] = @Original_itemSell_taxPercent)) AND ((@IsNull_itemSell_co" +
                "mment = 1 AND [itemSell_comment] IS NULL) OR ([itemSell_comment] = @Original_ite" +
                "mSell_comment)));\r\nSELECT itemSell_id, invoiceSell_id, invoiceSell_kind, object_" +
                "id, itemSell_unitCount, itemSell_retailCount, itemSell_retailPrice, itemSell_tot" +
                "alPrice, itemSell_discountPercent, itemSell_visitorPercent, itemSell_transportPr" +
                "ice, itemSell_taxPercent, itemSell_comment FROM tbl_itemsSell WHERE (itemSell_id" +
                " = @itemSell_id)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = @"SELECT        itemSell_id, invoiceSell_id, invoiceSell_kind, object_id, itemSell_unitCount, itemSell_retailCount, itemSell_retailPrice, itemSell_totalPrice, itemSell_discountPercent, 
                         itemSell_visitorPercent, itemSell_transportPrice, itemSell_taxPercent, itemSell_comment
FROM            tbl_itemsSell
WHERE        (invoiceSell_id = @invoiceSell_id) AND (invoiceSell_kind = @invoiceSell_kind)";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[0].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@invoiceSell_id", global::System.Data.SqlDbType.Int, 4, global::System.Data.ParameterDirection.Input, 0, 0, "invoiceSell_id", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[0].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@invoiceSell_kind", global::System.Data.SqlDbType.Bit, 1, global::System.Data.ParameterDirection.Input, 0, 0, "invoiceSell_kind", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
    ...
    public partial class tbl_invoicesSellTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [tbl_invoicesSell] WHERE (([invoiceSell_id] = @Original_invoiceSell_id) AND ([invoiceSell_kind] = @Original_invoiceSell_kind) AND ([person_id] = @Original_person_id) AND ([accDoc_id] = @Original_accDoc_id) AND ([invoiceSell_date] = @Original_invoiceSell_date) AND ([invoiceSell_totalPrice] = @Original_invoiceSell_totalPrice) AND ((@IsNull_invoiceSell_comment = 1 AND [invoiceSell_comment] IS NULL) OR ([invoiceSell_comment] = @Original_invoiceSell_comment)) AND ([invoiceSell_cashPrice] = @Original_invoiceSell_cashPrice) AND ([invoiceSell_discountPrice] = @Original_invoiceSell_discountPrice) AND ([invoiceSell_transportPrice] = @Original_invoiceSell_transportPrice))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_invoiceSell_id", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "invoiceSell_id", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_invoiceSell_kind", global::System.Data.SqlDbType.Bit, 0, global::System.Data.ParameterDirection.Input, 0, 0, "invoiceSell_kind", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [tbl_invoicesSell] ([invoiceSell_id], [invoiceSell_kind], [person_id], [accDoc_id], [invoiceSell_date], [invoiceSell_totalPrice], [invoiceSell_comment], [invoiceSell_cashPrice], [invoiceSell_discountPrice], [invoiceSell_transportPrice]) VALUES (@invoiceSell_id, @invoiceSell_kind, @person_id, @accDoc_id, @invoiceSell_date, @invoiceSell_totalPrice, @invoiceSell_comment, @invoiceSell_cashPrice, @invoiceSell_discountPrice, @invoiceSell_transportPrice);
SELECT invoiceSell_id, invoiceSell_kind, person_id, accDoc_id, invoiceSell_date, invoiceSell_totalPrice, invoiceSell_comment, invoiceSell_cashPrice, invoiceSell_discountPrice, invoiceSell_transportPrice FROM tbl_invoicesSell WHERE (invoiceSell_id = @invoiceSell_id) AND (invoiceSell_kind = @invoiceSell_kind)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@invoiceSell_id", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "invoiceSell_id", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@invoiceSell_kind", global::System.Data.SqlDbType.Bit, 0, global::System.Data.ParameterDirection.Input, 0, 0, "invoiceSell_kind", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [tbl_invoicesSell] SET [invoiceSell_id] = @invoiceSell_id, [invoiceSell_kind] = @invoiceSell_kind, [person_id] = @person_id, [accDoc_id] = @accDoc_id, [invoiceSell_date] = @invoiceSell_date, [invoiceSell_totalPrice] = @invoiceSell_totalPrice, [invoiceSell_comment] = @invoiceSell_comment, [invoiceSell_cashPrice] = @invoiceSell_cashPrice, [invoiceSell_discountPrice] = @invoiceSell_discountPrice, [invoiceSell_transportPrice] = @invoiceSell_transportPrice WHERE (([invoiceSell_id] = @Original_invoiceSell_id) AND ([invoiceSell_kind] = @Original_invoiceSell_kind) AND ([person_id] = @Original_person_id) AND ([accDoc_id] = @Original_accDoc_id) AND ([invoiceSell_date] = @Original_invoiceSell_date) AND ([invoiceSell_totalPrice] = @Original_invoiceSell_totalPrice) AND ((@IsNull_invoiceSell_comment = 1 AND [invoiceSell_comment] IS NULL) OR ([invoiceSell_comment] = @Original_invoiceSell_comment)) AND ([invoiceSell_cashPrice] = @Original_invoiceSell_cashPrice) AND ([invoiceSell_discountPrice] = @Original_invoiceSell_discountPrice) AND ([invoiceSell_transportPrice] = @Original_invoiceSell_transportPrice));
SELECT invoiceSell_id, invoiceSell_kind, person_id, accDoc_id, invoiceSell_date, invoiceSell_totalPrice, invoiceSell_comment, invoiceSell_cashPrice, invoiceSell_discountPrice, invoiceSell_transportPrice FROM tbl_invoicesSell WHERE (invoiceSell_id = @invoiceSell_id) AND (invoiceSell_kind = @invoiceSell_kind)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@invoiceSell_id", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "invoiceSell_id", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@invoiceSell_kind", global::System.Data.SqlDbType.Bit, 0, global::System.Data.ParameterDirection.Input, 0, 0, "invoiceSell_kind", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = @"SELECT        invoiceSell_id, invoiceSell_kind, person_id, accDoc_id, invoiceSell_date, invoiceSell_totalPrice, invoiceSell_comment, invoiceSell_cashPrice, 
                         invoiceSell_discountPrice, invoiceSell_transportPrice
FROM            tbl_invoicesSell
WHERE        (invoiceSell_id = @invoiceSell_id) AND (invoiceSell_kind = @invoiceSell_kind)";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[0].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@invoiceSell_id", global::System.Data.SqlDbType.Int, 4, global::System.Data.ParameterDirection.Input, 0, 0, "invoiceSell_id", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[0].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@invoiceSell_kind", global::System.Data.SqlDbType.Bit, 1, global::System.Data.ParameterDirection.Input, 0, 0, "invoiceSell_kind", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(int invoiceSell_id, bool invoiceSell_kind, int person_id, int accDoc_id, string invoiceSell_date, long invoiceSell_totalPrice, string invoiceSell_comment, long invoiceSell_cashPrice, long invoiceSell_discountPrice, long invoiceSell_transportPrice) {
            this.Adapter.InsertCommand.Parameters[0].Value = ((int)(invoiceSell_id));
            this.Adapter.InsertCommand.Parameters[1].Value = ((bool)(invoiceSell_kind));
        ...
        public virtual int Update(
            ...
            this.Adapter.UpdateCommand.Parameters[10].Value = ((int)(Original_invoiceSell_id));
            this.Adapter.UpdateCommand.Parameters[11].Value = ((bool)(Original_invoiceSell_kind));
            ...
            if ((Original_invoiceSell_date == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[14].Value = ((string)(Original_invoiceSell_date));
            }
            this.Adapter.UpdateCommand.Parameters[15].Value = ((long)(Original_invoiceSell_totalPrice));
            if ((Original_invoiceSell_comment == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[17].Value = ((string)(Original_invoiceSell_comment));
            }
            this.Adapter.UpdateCommand.Parameters[18].Value = ((long)(Original_invoiceSell_cashPrice));
            this.Adapter.UpdateCommand.Parameters[19].Value = ((long)(Original_invoiceSell_discountPrice));
            this.Adapter.UpdateCommand.Parameters[20].Value = ((long)(Original_invoiceSell_transportPrice));
            global::System.Data.ConnectionState previousConnectionState = this.Adapter.UpdateCommand.Connection.State;
            if (((this.Adapter.UpdateCommand.Connection.State & global::System.Data.ConnectionState.Open) 
                        != global::System.Data.ConnectionState.Open)) {
                this.Adapter.UpdateCommand.Connection.Open();
        ...
        public virtual int Update(
                    ...
                    long Original_invoiceSell_discountPrice, 
                    long Original_invoiceSell_transportPrice) {
            return this.Update(Original_invoiceSell_id, Original_invoiceSell_kind, person_id, accDoc_id, invoiceSell_date, invoiceSell_totalPrice, invoiceSell_comment, invoiceSell_cashPrice, invoiceSell_discountPrice, invoiceSell_transportPrice, Original_invoiceSell_id, Original_invoiceSell_kind, Original_person_id, Original_accDoc_id, Original_invoiceSell_date, Original_invoiceSell_totalPrice, Original_invoiceSell_comment, Original_invoiceSell_cashPrice, Original_invoiceSell_discountPrice, Original_invoiceSell_transportPrice);
        }
    }
