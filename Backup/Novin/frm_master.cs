...
namespace Novin
{
    public partial class frm_master : Form
    {
        ...
        {            
            if (cls_users.usersCount() == 2)
            {
                ...
                if (dt_users.Rows[1]["user_password"] != DBNull.Value)
                {
                    ...
                    {
                        //کاربر به نرم افزار لوگ آن میشود
                    }
                }
                else
                {
                    cls_users.user_id = Convert.ToInt32(dt_users.Rows[1]["user_id"]);
                }
            }
        ...
        private void toolStripMenuItem45_Click(object sender, EventArgs e)
        {
            ...
            frmPersons.b_userCanEditPrimaryCycleData = false;
        ...
        private void toolStripMenuItem46_Click(object sender, EventArgs e)
        {
            ...
            _frm_objects.b_userCanEditThePrimaryCycleEntity = false;
        ...
        private void mnu_dataInput_primary_mineCheques_Click(object sender, EventArgs e)
        {
            ...
            _frm_cheques.isItPrimaryCycleCheques = true;
        ...
        private void frm_master_Load(object sender, EventArgs e)
        {
            ...
            if (cls_accDoc.isItPrimaryCycle)
            {
                ...
                mnu_dataEntry_primaryCycle_personsIndebedCreditorMoney.Visible = false;
                mnu_primaryCycle_primaryCycleObjectEntity.Visible = false;
                mnu_dataEntry_sep1.Visible = false;
                mnu_dataEntry_sep2.Visible = false;

                this.Text += " (اول دروه) ";
            }
            else//if it is not primary cycle
            {
            ...
            lbl_nowDate.Text = shamsiDate.Persian;
        }
        ...
        private void mnu_report_objectAdvDisadv_Click(object sender, EventArgs e)
        {
            ...
            _print.s_reportFilePath = cls_myDataAccessLayer.s_pathRun +  @"\rpt_profLoss.rpt";
        ...
        private void mnu_jaavidAndReza_quit_Click(object sender, EventArgs e)
        {
            Close();
        }

        private void mnu_actions_soltObjectExplorer_Click(object sender, EventArgs e)
        {
            frm_soldObjectExplorer _frm_soldObjectExplorer = new frm_soldObjectExplorer();
            _frm_soldObjectExplorer.ShowDialog();
        }

        private void mnu_dataEntry_primaryCycle_personsIndebedCreditorMoney_Click(object sender, EventArgs e)
        {
            frm_persons frmPersons = new frm_persons();
            frmPersons.b_userCanEditPrimaryCycleData = true;
            frmPersons.tab_Person.SelectedIndex = 1;
            frmPersons.ShowDialog();
        }

        private void mnu_preferences_SARFASL_Click(object sender, EventArgs e)
        {
            frm_accountingChapters _frm_accountingChapters = new frm_accountingChapters();
            _frm_accountingChapters.ShowDialog();
        }

        private void mnu_objects_objectsCaradox_Click(object sender, EventArgs e)
        {

        }

        private void mnu_actions_invoices_preInvoice_Click(object sender, EventArgs e)
        {
            frm_invoicesSell _frm_sellInvoice = new frm_invoicesSell();
            _frm_sellInvoice.openForReturnBuyInvoice = false;
            _frm_sellInvoice.openForModify = false;
            _frm_sellInvoice.b_isItPreInvoice = true;
            _frm_sellInvoice.ShowDialog();
        }
