...
namespace Novin {
    ...
    public partial class ds_finActs : global::System.Data.DataSet {
        ...
        public partial class tbl_finActsDataTable : global::System.Data.TypedTableBase<tbl_finActsRow> {
            ...
            private global::System.Data.DataColumn columnfinAct_deleted;
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            public global::System.Data.DataColumn finAct_deletedColumn {
                get {
                    return this.columnfinAct_deleted;
                }
            }
            ...
            internal void InitVars() {
                ...
                this.columnfinAct_deleted = base.Columns["finAct_deleted"];
            }
            ...
            private void InitClass() {
                ...
                this.columnfinAct_deleted = new global::System.Data.DataColumn("finAct_deleted", typeof(bool), null, global::System.Data.MappingType.Element);
                base.Columns.Add(this.columnfinAct_deleted);
        ...
        public partial class tbl_finActsRow : global::System.Data.DataRow {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            public bool finAct_deleted {
                get {
                    try {
                        return ((bool)(this[this.tabletbl_finActs.finAct_deletedColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'finAct_deleted\' in table \'tbl_finActs\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tabletbl_finActs.finAct_deletedColumn] = value;
                }
            }
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            public bool IsfinAct_deletedNull() {
                return this.IsNull(this.tabletbl_finActs.finAct_deletedColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            public void SetfinAct_deletedNull() {
                this[this.tabletbl_finActs.finAct_deletedColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace Novin.ds_finActsTableAdapters {
    ...
    public partial class tbl_finActsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@IsNull_finAct_deleted", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "finAct_deleted", global::System.Data.DataRowVersion.Original, true, null, "", "", ""));
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_finAct_deleted", global::System.Data.SqlDbType.Bit, 0, global::System.Data.ParameterDirection.Input, 0, 0, "finAct_deleted", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [tbl_finActs] ([finAct_id], [accDoc_id], [finAct_type], [person_id], [accountFrom_id], [accountTo_id], [moeen_id], [finAct_money], [finAct_cashMoney], [finAct_chequesMoney], [finAct_indebtedMoney], [finAct_useChequesMoney], [finAct_deleted]) VALUES (@finAct_id, @accDoc_id, @finAct_type, @person_id, @accountFrom_id, @accountTo_id, @moeen_id, @finAct_money, @finAct_cashMoney, @finAct_chequesMoney, @finAct_indebtedMoney, @finAct_useChequesMoney, @finAct_deleted);
SELECT finAct_id, accDoc_id, finAct_type, person_id, accountFrom_id, accountTo_id, moeen_id, finAct_money, finAct_cashMoney, finAct_chequesMoney, finAct_indebtedMoney, finAct_useChequesMoney, finAct_deleted FROM tbl_finActs WHERE (finAct_id = @finAct_id)";
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@finAct_deleted", global::System.Data.SqlDbType.Bit, 0, global::System.Data.ParameterDirection.Input, 0, 0, "finAct_deleted", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = "UPDATE [tbl_finActs] SET [finAct_id] = @finAct_id, [accDoc_id] = @accDoc_id, [fin" +
                "Act_type] = @finAct_type, [person_id] = @person_id, [accountFrom_id] = @accountF" +
                "rom_id, [accountTo_id] = @accountTo_id, [moeen_id] = @moeen_id, [finAct_money] =" +
                " @finAct_money, [finAct_cashMoney] = @finAct_cashMoney, [finAct_chequesMoney] = " +
                "@finAct_chequesMoney, [finAct_indebtedMoney] = @finAct_indebtedMoney, [finAct_us" +
                "eChequesMoney] = @finAct_useChequesMoney, [finAct_deleted] = @finAct_deleted WHE" +
                "RE (([finAct_id] = @Original_finAct_id) AND ([accDoc_id] = @Original_accDoc_id) " +
                "AND ([finAct_type] = @Original_finAct_type) AND ((@IsNull_person_id = 1 AND [per" +
                "son_id] IS NULL) OR ([person_id] = @Original_person_id)) AND ((@IsNull_accountFr" +
                "om_id = 1 AND [accountFrom_id] IS NULL) OR ([accountFrom_id] = @Original_account" +
                "From_id)) AND ((@IsNull_accountTo_id = 1 AND [accountTo_id] IS NULL) OR ([accoun" +
                "tTo_id] = @Original_accountTo_id)) AND ((@IsNull_moeen_id = 1 AND [moeen_id] IS " +
                "NULL) OR ([moeen_id] = @Original_moeen_id)) AND ([finAct_money] = @Original_finA" +
                "ct_money) AND ([finAct_cashMoney] = @Original_finAct_cashMoney) AND ([finAct_che" +
                "quesMoney] = @Original_finAct_chequesMoney) AND ([finAct_indebtedMoney] = @Origi" +
                "nal_finAct_indebtedMoney) AND ([finAct_useChequesMoney] = @Original_finAct_useCh" +
                "equesMoney) AND ((@IsNull_finAct_deleted = 1 AND [finAct_deleted] IS NULL) OR ([" +
                "finAct_deleted] = @Original_finAct_deleted)));\r\nSELECT finAct_id, accDoc_id, fin" +
                "Act_type, person_id, accountFrom_id, accountTo_id, moeen_id, finAct_money, finAc" +
                "t_cashMoney, finAct_chequesMoney, finAct_indebtedMoney, finAct_useChequesMoney, " +
                "finAct_deleted FROM tbl_finActs WHERE (finAct_id = @finAct_id)";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@finAct_deleted", global::System.Data.SqlDbType.Bit, 0, global::System.Data.ParameterDirection.Input, 0, 0, "finAct_deleted", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@IsNull_finAct_deleted", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "finAct_deleted", global::System.Data.DataRowVersion.Original, true, null, "", "", ""));
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_finAct_deleted", global::System.Data.SqlDbType.Bit, 0, global::System.Data.ParameterDirection.Input, 0, 0, "finAct_deleted", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = @"SELECT        finAct_id, accDoc_id, finAct_type, person_id, accountFrom_id, accountTo_id, moeen_id, finAct_money, finAct_cashMoney, finAct_chequesMoney, 
                         finAct_indebtedMoney, finAct_useChequesMoney, finAct_deleted
FROM            tbl_finActs
WHERE        (finAct_id = @finAct_id)";
        ...
        public virtual int Delete(int Original_finAct_id, int Original_accDoc_id, int Original_finAct_type, global::System.Nullable<int> Original_person_id, global::System.Nullable<int> Original_accountFrom_id, global::System.Nullable<int> Original_accountTo_id, string Original_moeen_id, long Original_finAct_money, long Original_finAct_cashMoney, long Original_finAct_chequesMoney, long Original_finAct_indebtedMoney, long Original_finAct_useChequesMoney, global::System.Nullable<bool> Original_finAct_deleted) {
            ...
            if ((Original_finAct_deleted.HasValue == true)) {
                this.Adapter.DeleteCommand.Parameters[16].Value = ((object)(0));
                this.Adapter.DeleteCommand.Parameters[17].Value = ((bool)(Original_finAct_deleted.Value));
            }
            else {
        ...
        public virtual int Insert(int finAct_id, int accDoc_id, int finAct_type, global::System.Nullable<int> person_id, global::System.Nullable<int> accountFrom_id, global::System.Nullable<int> accountTo_id, string moeen_id, long finAct_money, long finAct_cashMoney, long finAct_chequesMoney, long finAct_indebtedMoney, long finAct_useChequesMoney, global::System.Nullable<bool> finAct_deleted) {
            ...
            if ((finAct_deleted.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[12].Value = ((bool)(finAct_deleted.Value));
            }
            else {
        ...
        public virtual int Update(
                    ...
                    global::System.Nullable<bool> finAct_deleted, 
                    ...
                    global::System.Nullable<bool> Original_finAct_deleted) {
            ...
            if ((finAct_deleted.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[12].Value = ((bool)(finAct_deleted.Value));
            }
            else {
                this.Adapter.UpdateCommand.Parameters[12].Value = global::System.DBNull.Value;
            }
            this.Adapter.UpdateCommand.Parameters[13].Value = ((int)(Original_finAct_id));
            this.Adapter.UpdateCommand.Parameters[14].Value = ((int)(Original_accDoc_id));
            this.Adapter.UpdateCommand.Parameters[15].Value = ((int)(Original_finAct_type));
            if ((Original_person_id.HasValue == true)) {
            ...
            if ((Original_accountFrom_id.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[19].Value = ((int)(Original_accountFrom_id.Value));
            }
            else {
            ...
            if ((Original_accountTo_id.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[21].Value = ((int)(Original_accountTo_id.Value));
            }
            else {
            ...
            if ((Original_moeen_id == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[23].Value = ((string)(Original_moeen_id));
            }
            this.Adapter.UpdateCommand.Parameters[24].Value = ((long)(Original_finAct_money));
            this.Adapter.UpdateCommand.Parameters[25].Value = ((long)(Original_finAct_cashMoney));
            this.Adapter.UpdateCommand.Parameters[26].Value = ((long)(Original_finAct_chequesMoney));
            this.Adapter.UpdateCommand.Parameters[27].Value = ((long)(Original_finAct_indebtedMoney));
            this.Adapter.UpdateCommand.Parameters[28].Value = ((long)(Original_finAct_useChequesMoney));
            if ((Original_finAct_deleted.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[29].Value = ((object)(0));
                this.Adapter.UpdateCommand.Parameters[30].Value = ((bool)(Original_finAct_deleted.Value));
            }
            else {
        ...
        public virtual int Update(
                    ...
                    long Original_finAct_useChequesMoney, 
                    global::System.Nullable<bool> Original_finAct_deleted) {
            return this.Update(Original_finAct_id, accDoc_id, finAct_type, person_id, accountFrom_id, accountTo_id, moeen_id, finAct_money, finAct_cashMoney, finAct_chequesMoney, finAct_indebtedMoney, finAct_useChequesMoney, finAct_deleted, Original_finAct_id, Original_accDoc_id, Original_finAct_type, Original_person_id, Original_accountFrom_id, Original_accountTo_id, Original_moeen_id, Original_finAct_money, Original_finAct_cashMoney, Original_finAct_chequesMoney, Original_finAct_indebtedMoney, Original_finAct_useChequesMoney, Original_finAct_deleted);
        }
    }
...
SELECT accDoc_id, accDoc_price, accDoc_date, accDoc_comment, accDoc_isItPerm, accDoc_deleted FROM tbl_accDocs WHERE (accDoc_id = @accDoc_id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT        accDoc_id, accDoc_price, accDoc_date, accDoc_comment, accDoc_isItPe" +
                "rm, accDoc_deleted\r\nFROM            tbl_accDocs";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
